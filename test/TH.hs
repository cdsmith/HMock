...
instance Typeable a => Mockable (MonadFoo2 a) where
  data Action (MonadFoo2 a) :: Type -> Type
    where Foo2 :: a -> Action (MonadFoo2 a) ()
  data Matcher (MonadFoo2 a) :: Type -> Type
    where Foo2_ :: Predicate a -> Matcher (MonadFoo2 a) ()
...
instance (Typeable a, Typeable m_aHW4f, Monad m_aHW4f) =>
         MonadFoo2 a (MockT m_aHW4f) where
